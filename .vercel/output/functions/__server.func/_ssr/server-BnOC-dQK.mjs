...
import { $t as queueAfterTransactionHook, B as record, C as runWithEndpointContext, D as serializeSignedCookie, E as serializeCookie, Gt as withSpan, I as looseObject, J as decodeProtectedHeader, Jt as ATTR_OPERATION_ID, K as base64Url, Kt as ATTR_CONTEXT, L as number, M as array, N as boolean, O as filterOutputFields, P as email, Qt as getCurrentAdapter, R as object, S as getCurrentAuthContext, T as toResponse, V as string, X as jwtVerify, Xt as safeJSONParse, Y as importJWK, Yt as import_src, Zt as getAuthTables, _ as createAuthMiddleware, _n as APIError, a as betterFetch, an as generateId, b as hasRequestState, bn as BASE_ERROR_CODES, c as applyDefaultAccessTokenExpiry, cn as logger, d as findInvalidTrustedProxies, dn as env, en as runWithAdapter, f as getIp, g as createAuthEndpoint, gn as isTest, h as normalizePathname, hn as isProduction, i as refreshAccessToken, in as initGetFieldName, j as any, jt as JWTExpired, l as isLoopbackHost, ln as shouldPublishLog, mn as isDevelopment, n as socialProviders, nn as getBetterAuthVersion, on as createRandomStringGenerator, p as deprecate, q as decodeJwt, qt as ATTR_HOOK_TYPE, r as validateAuthorizationCode, rn as initGetModelName, s as createAuthorizationURL, sn as createLogger, t as SocialProviderListEnum, tn as runWithTransaction, u as createRateLimitKey, v as isAPIError, vn as BetterAuthError, w as createRouter$1, x as runWithRequestState, xn as defineErrorCodes, y as defineRequestState, yn as kAPIErrorHeaderSymbol, yt as encode, z as optional } from "../_libs/@better-auth/core+[...].mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/server-BnOC-dQK.js
function env$2(key) {
...
async function createPgliteSql() {
	...
	const migrate = async () => {
		const migrations = /* #__PURE__ */ Object.assign({
			...
			"/migrations/0002_estimator.sql": _0002_estimator_default
		});
...
//#endregion
export { authConfigured as a, auth as i, GROK_PROVIDERS as n, gateIdentityEnabled as o, PACKAGE_VERSION as r, getBaseURL as s, GENERIC_OAUTH_ERROR_CODES as t };
