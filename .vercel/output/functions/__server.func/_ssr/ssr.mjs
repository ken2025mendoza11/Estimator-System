...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DUSf5zga.mjs");
...
var manifest = { "2c4985e96c199268f7f639534cb5e8e31d6b19d43286bf77416413db60ffde26": {
	...
	importer: () => import("../__root-Xa37Neb8.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BsB4S6cU.mjs").then((n) => n.t),
...
//#endregion
export { getRequest as a, createServerEntry, server_default as default, getServerFnById as i, createServerFn as n, ssr_exports as o, TSS_SERVER_FUNCTION as r, server_exports as t };
